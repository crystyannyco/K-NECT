...
<head>
    ...
    <style>
        ...
        @keyframes glow-pulse {
            ...
            50% {
                filter: drop-shadow(0 0 20px rgba(255, 255, 255, 0.9)) drop-shadow(0 0 35px rgba(255, 255, 255, 0.5));
            }
        }
...
<body class="login-bg min-h-screen relative">
    ...
    <div class="min-h-screen flex flex-col lg:flex-row login-content">
        ...
        <div class="lg:hidden w-full text-center pb-4 pt-10">
            <img src="<?= base_url('/assets/images/K-Nect-Logo.png') ?>" alt="K-NECT Logo" class="w-56 mx-auto mb-1 drop-shadow-xl glow-logo mobile-logo-top-padding animate-fade-in-up" />
            <h2 class="text-xl font-semibold text-white animate-fade-in-up animate-delay-1">KABATAAN CONNECT</h2>
        </div>

        <!-- Left Side - System Title and Description (Desktop) -->
        <div class="hidden lg:flex lg:w-1/2 flex-col justify-center items-center p-12 text-center lg:text-left pt-16">
            <div class="max-w-md flex flex-col items-center lg:items-start">
                <img src="<?= base_url('/assets/images/K-Nect-Logo.png') ?>" alt="K-NECT Logo" class="w-64 mb-1 drop-shadow-xl glow-logo items-center logo-top-padding animate-fade-in-up" />
                <h2 class="text-2xl md:text-2xl font-bold text-white mb-2 animate-fade-in-up animate-delay-1">
                    KABATAAN CONNECT
                </h2>
                <p class="text-base text-white leading-relaxed mb-6 animate-fade-in-up animate-delay-2">
            ...
            <div id="loginError" class="mt-1 text-red-600 text-xs hidden"></div>
                ...
                <div class="space-y-2">
                    ...
                    <button type="button" id="togglePassword" class="absolute inset-y-0 right-0 pr-3 flex items-center z-10">
                        ...
                        <svg id="eyeIconClosed" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="h-5 w-5 text-gray-400 hover:text-gray-600 transition-colors hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path d="M2 12c2.5-4 6.5-7 10-7s7.5 3 10 7c-2.5 4-6.5 7-10 7s-7.5-3-10-7z"/>
                            <circle cx="12" cy="12" r="2.5"/>
                ...
                <!-- Footer -->
                <div class="text-center mt-4 pt-3 border-gray-100">
