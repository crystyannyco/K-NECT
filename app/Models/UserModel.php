...
class UserModel extends Model
{
    ...
    protected $allowedFields = ['last_name','first_name','middle_name','sex','gender', 'suffix','birthdate','email','phone_number', 'username','status','user_type','position','is_active','deactivation_reason','password','sk_username','sk_password','ped_username','ped_password','ped_position','created_at','updated_at', 'user_id', 'last_login', 'rfid_code'];
