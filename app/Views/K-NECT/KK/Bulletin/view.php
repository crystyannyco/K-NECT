                ...
                <div class="flex-1 min-w-0">
                    <nav class="flex" aria-label="Breadcrumb">
                        <ol class="flex items-center space-x-4">
                            <li>
                                <div>
                                    <a href="<?= base_url('/kk/dashboard') ?>" class="text-gray-400 hover:text-gray-500">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="<?= base_url('/kk/dashboard') ?>" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">
                                        Bulletin Board
                                    </a>
                                </div>
                            </li>
