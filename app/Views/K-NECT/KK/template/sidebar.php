		...
		<div id="sidebar" class="w-64 sidebar-glass shadow-strong sidebar-transition flex-shrink-0 fixed top-0 left-0 bottom-0 z-30 transform -translate-x-full lg:translate-x-0">
			<div class="flex flex-col h-full">
                ...
                <div class="p-4 border-t border-gray-100">
                    <a href="<?= base_url('/kk/settings') ?>" class="nav-item flex items-center gap-3 p-3 rounded-xl text-gray-700 hover:bg-gray-50 font-medium <?= (uri_string() == 'kk/settings' || uri_string() == 'kk/profile') ? 'active' : '' ?>">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
