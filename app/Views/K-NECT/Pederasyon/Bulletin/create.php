            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <p class="mt-1 text-sm text-blue-100 max-w-2xl">
                        Share news, announcements, and updates with the community
                    </p>
                </div>
                        ...
                        <div class="p-5">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="content" name="content" rows="12" required
                                          ...
                                          placeholder="Write your post content here... Share your thoughts, announcements, or updates with the community."></textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="relative">
                                    ...
                                    <select id="visibility" name="visibility" required
                                        ...
                                        <?php if ($user_type === 'sk'): ?>
                                        <option value="barangay" selected>Barangay Only</option>
                                        <?php elseif ($user_type === 'pederasyon'): ?>
                                        <option value="barangay">Barangay Only</option>
                                        <option value="city" selected>City-wide</option>
                                        <?php endif; ?>
                                    </select>
                                </div>
                                <div class="mt-2 flex items-start space-x-1.5 text-xs text-gray-500">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    statusSelect.addEventListener('change', function() {
        publishBtnText.textContent = this.value === 'published' ? 'Publish Post' : 'Save Post';
    });

    // Handle draft button
    draftBtn.addEventListener('click', function() {
        statusSelect.value = 'draft';
        publishBtnText.textContent = 'Save Draft';
    ...
    if (barangaySelect && visibilitySelect) {
        barangaySelect.addEventListener('change', () => {
            if (barangaySelect.value) {
                ...
                // Default back to city-wide if user cleared selection and city option exists
