        ...
        <div class="px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <?php if (in_array($user_type, ['sk', 'pederasyon']) && 
                         ($user_type === 'pederasyon' || $post['author_id'] == session('user_id'))): ?>
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <?php if (in_array($user_type, ['sk','pederasyon']) && ($user_type === 'pederasyon' || $post['author_id'] == session('user_id'))): ?>
                            <a href="<?= base_url('/bulletin/edit/' . $post['id']) ?>" 
                               class="w-full inline-flex justify-center items-center px-4 py-2 border border-blue-500 rounded-md shadow-sm text-sm font-medium text-blue-600 bg-white hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                </svg>
                                Edit Post
