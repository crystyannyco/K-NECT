        ...
        <div class="max-w-full mx-auto px-6 py-6">
            <div class="flex flex-wrap items-center justify-between gap-6">
                ...
                <div class="flex items-center gap-2 flex-1 min-w-0">
                    ...
                    <!-- Event Info -->
                    <div class="min-w-0">
                        <h2 class="text-sm font-bold uppercase text-blue-800">
                            Pederasyon ng Sangguniang Kabataan
                        </h2>
                        <h2 class="text-base font-bold uppercase mb-1 text-blue-800">
                            City-Wide Event Monitoring
                        </h2>
                ...
                <div class="flex flex-col items-end justify-center bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 min-w-[250px] shadow-sm">
                    ...
                    <div class="text-xs text-gray-500 mb-3" id="pmSessionTimes">
                    <!-- Controls -->
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50 sticky top-0">
                            <tr>
                                ...
                                <th class="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Barangay</th>
    ...
    <script>
        ...
        function updateLiveAttendanceTable(attendanceData) {
            ...
            tableBody.innerHTML = recentData.map((record, index) => {
                ...
                const barangay = record.barangay || 'N/A';
                ...
                return `
                    <tr class="hover:bg-gray-50 ${rowClass}">
                        ...
                        <td class="px-3 py-4 whitespace-nowrap text-sm text-gray-500">${barangay}</td>
