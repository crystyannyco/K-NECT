            ...
            <div class="mb-8">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    ...
                    <div class="mt-3 sm:mt-0">
                                <a href="<?= base_url('pederasyon/account-settings') ?>"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-gray-900">
                                    ...
                                    echo $positionMap[$user['position']] ?? 'Pederasyon Officer';
                                    ?>
                                </p>
                            </div>
                            <?php endif; ?>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-sm font-medium text-gray-900">
                                <?= $civilStatusMap[$userExtInfo['civil_status']] ?? 'Not specified' ?>
                            </span>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-sm font-medium text-gray-900">
                                <?= $youthClassificationMap[$userExtInfo['youth_classification']] ?? 'Not specified' ?>
                            </span>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-sm font-medium text-gray-900">
                                <?= $workStatusMap[$userExtInfo['work_status']] ?? 'Not specified' ?>
                            </span>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-sm font-medium text-gray-900">
                                <?= $educationalBackgroundMap[$userExtInfo['educational_background']] ?? 'Not specified' ?>
                            </span>
                        </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-sm font-medium text-gray-900">
                                <?= $howManyTimesMap[$userExtInfo['how_many_times']] ?? 'Not specified' ?>
                            </span>
                        </div>
                        <?php endif; ?>
                    </div>
