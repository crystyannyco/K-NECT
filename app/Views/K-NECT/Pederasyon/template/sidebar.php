        ...
        <div id="sidebar" class="w-64 sidebar-glass shadow-strong sidebar-transition flex-shrink-0 fixed top-0 left-0 bottom-0 z-30 transform -translate-x-full lg:translate-x-0">
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="<?= base_url('/pederasyon/attendance') ?>" class="nav-item flex items-center gap-3 px-3 py-2 rounded-xl text-gray-700 hover:bg-gray-50 font-medium <?= (strpos(uri_string(), 'pederasyon/attendance') === 0) ? 'active' : '' ?>">
                                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="space-y-1">
                            <a href="<?= base_url('/pederasyon/skchairperson') ?>" class="nav-item flex items-center gap-3 px-3 py-2 rounded-xl text-gray-700 hover:bg-gray-50 font-medium <?= (uri_string() == 'pederasyon/skchairperson') ? 'active' : '' ?>">
                                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-4 border-t border-gray-100">
                    <?php
                        $isSettingsActive = (
                            uri_string() == 'pederasyon/settings' ||
                            uri_string() == 'pederasyon/account-settings' ||
                            strpos(uri_string(), 'pederasyon/settings') === 0 ||
                            strpos(uri_string(), 'pederasyon/account-settings') === 0
                        );
                    ?>
                    <a href="<?= base_url('/pederasyon/settings') ?>" class="nav-item flex items-center gap-3 p-3 rounded-xl text-gray-700 hover:bg-gray-50 font-medium <?= $isSettingsActive ? 'active' : '' ?>">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
