            ...
            <div class="px-6 py-6 text-white rounded-t-2xl" style="background-color: #001833;">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="<?= base_url('admin/documents') ?>" class="bg-white/20 text-white px-4 py-2 rounded-lg text-sm font-medium shadow-sm hover:bg-white/30 transition-colors flex items-center gap-2">
                                        ...
                                        <td class="py-3 px-4 text-center">
                                            <div class="flex flex-col gap-2 items-center">
                                                <?php if (in_array($doc['permissions'], ['download', 'edit', 'admin'])): ?>
                                                    <a href="<?= base_url('admin/documents/download/' . $doc['document_id']) ?>" 
                                                ...
                                                <a href="<?= base_url('admin/documents/preview/' . $doc['document_id']) ?>" 
                                                   class="bg-blue-600 text-white px-3 py-1.5 rounded-lg text-xs font-medium shadow-sm hover:bg-blue-700 transition-colors flex items-center gap-1.5 w-full justify-center" 
                                                   title="Preview">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                ...
                                                <?php if (in_array($doc['permissions'], ['edit', 'admin'])): ?>
                                                    <a href="<?= base_url('admin/documents/edit/' . $doc['document_id']) ?>" 
                                                       class="text-white px-3 py-1.5 rounded-lg text-xs font-medium shadow-sm hover:bg-gray-800 transition-colors flex items-center gap-1.5 w-full justify-center" 
