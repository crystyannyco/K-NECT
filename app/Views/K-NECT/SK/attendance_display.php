                    ...
                    <div class="flex-shrink-0 flex items-center gap-3">
                        <div class="relative">
                            <?php if (!empty($barangay_logo['file_path'])): ?>
                                <img src="<?= base_url($barangay_logo['file_path']) ?>" alt="<?= esc($barangay_logo['logo_name']) ?>" class="w-24 h-24 rounded-full ring-4 ring-white/20 shadow-lg">
                            <?php else: ?>
                        ...
                        <div class="relative">
                            <?php if (!empty($sk_logo['file_path'])): ?>
                                <img src="<?= base_url($sk_logo['file_path']) ?>" alt="<?= esc($sk_logo['logo_name']) ?>" class="w-24 h-24 rounded-full ring-4 ring-white/20 shadow-lg">
                            <?php else: ?>
                                <div class="w-24 h-24 bg-white/20 rounded-full flex items-center justify-center ring-4 ring-white/20 shadow-lg">
                                    <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="text-center lg:text-left">
                            ...
                            <h2 class="text-lg font-bold uppercase mb-2 text-white tracking-wide">
                                Sangguniang Kabataan ng <?= esc($barangay_name) ?>
                            </h2>
