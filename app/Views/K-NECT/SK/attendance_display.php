            ...
            <div class="flex flex-col lg:flex-row items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-4 flex-1 min-w-0 w-full lg:w-auto">
                    <div class="flex-shrink-0 flex items-center gap-3">
                        <div class="relative">
                            <?php if (!empty($barangay_logo['file_path'])): ?>
                                <img src="<?= base_url($barangay_logo['file_path']) ?>" alt="<?= esc($barangay_logo['logo_name']) ?>" class="w-16 h-16 rounded-full ring-2 ring-white/20 shadow-md">
                            <?php else: ?>
                        ...
                        <div class="relative">
                            <?php if (!empty($sk_logo['file_path'])): ?>
                                <img src="<?= base_url($sk_logo['file_path']) ?>" alt="<?= esc($sk_logo['logo_name']) ?>" class="w-16 h-16 rounded-full ring-2 ring-white/20 shadow-md">
                            <?php else: ?>
                                <div class="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center ring-2 ring-white/20 shadow-md">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="text-center lg:text-left">
                            <h2 class="text-xs font-bold uppercase text-blue-900 tracking-wide">Barangay <?= esc($barangay_name) ?></h2>
                            <h2 class="text-base font-bold uppercase mb-1 text-blue-400 tracking-wide">Sangguniang Kabataan ng <?= esc($barangay_name) ?></h2>
