    ...
    <main class="flex-1 overflow-auto p-6 bg-gray-50">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <select id="monthsFilter" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" onchange="refreshCharts()">
        ...
        <div class="mb-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="bg-white rounded-lg shadow-sm p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        <h3 class="text-sm font-medium text-gray-500">Published Events</h3>
                        <p class="text-2xl font-bold text-gray-900"><?= $event_summary['total_published_events'] ?? 0 ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        <h3 class="text-sm font-medium text-gray-500">Unique Participants</h3>
                        <p class="text-2xl font-bold text-gray-900"><?= $event_summary['total_unique_participants'] ?? 0 ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        <h3 class="text-sm font-medium text-gray-500">Total Attendances</h3>
                        <p class="text-2xl font-bold text-gray-900"><?= $event_summary['total_attendances'] ?? 0 ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        ...
                        <p class="text-2xl font-bold text-gray-900"><?= round($event_summary['avg_attendance_duration'] ?? 0) ?> min</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-white rounded-lg shadow-sm">
                ...
                <div class="p-6">
                    <div id="genderParticipationChart" style="height: 300px;"></div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-sm">
                ...
                <div class="p-6">
                    <div id="activeMembersTable" class="overflow-x-auto">
...
<script>
    ...
    function refreshCharts() {
        ...
        <?php if ($view_type === 'citywide'): ?>
        // Top barangays doesn't change with filters in citywide view
        <?php endif; ?>
    }
    ...
    // Load Top Active Members Table
    function loadTopActiveMembersTable() {
        const params = new URLSearchParams({
            view_type: viewType
        });
        ...
        $.get(`${baseApiUrl}/top-active-members?${params.toString()}`)
            .done(function(data) {
                let tableHtml = `
                ...
                $('#activeMembersTable').html(tableHtml);
            })
            .fail(function() {
                $('#activeMembersTable').html('<div class="text-center text-gray-500">Error loading active members data</div>');
            });
    }
