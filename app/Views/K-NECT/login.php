    ...
    <div class="min-h-screen flex flex-col lg:flex-row login-content">
        ...
        <div class="hidden lg:flex lg:w-1/2 flex-col justify-center items-center p-12 text-center lg:text-left pt-16">
            <div class="max-w-md flex flex-col items-center lg:items-start">
                <img src="<?= base_url('/assets/images/K-Nect-Logo.png') ?>" alt="K-NECT Logo" class="w-64 mb-1 drop-shadow-xl glow-logo items-center logo-top-padding" />
                <h2 class="text-2xl md:text-2xl font-bold text-white mb-2">
                    KABATAAN CONNECT
                </h2>
